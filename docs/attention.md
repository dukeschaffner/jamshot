...
- After marketing pages moved to static UI: tear down Amplify app `sterio-cms`, DNS for `cms.sterio.fm` / `test-cms.sterio.fm`, CMS Neon DB, and related Amplify/SSM secrets (`/jamshot/cms/*`). Not removed automatically by the UI deploy.
