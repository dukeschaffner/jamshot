...
const typeDefinitions = `// Type definitions for @jamshot/subscription-config
...
fs.writeFileSync(distPath, typeDefinitions);

console.log('TypeScript definitions completed: dist/index.d.ts'); 