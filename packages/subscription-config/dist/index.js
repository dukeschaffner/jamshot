...
const getPlanByTier = (tier, plans = SUBSCRIPTION_PLANS_BASE) => {
  return plans[tier] || null;
};

// Utility function to validate subscription limits
const validateSubscriptionLimits = (tier, action, count) => {
...
module.exports.SUBSCRIPTION_PLANS_BASE = SUBSCRIPTION_PLANS_BASE;
module.exports.createSubscriptionPlans = createSubscriptionPlans;
module.exports.isValidTier = isValidTier;
module.exports.compareTiers = compareTiers;
module.exports.getTierRank = getTierRank;
module.exports.isUpgrade = isUpgrade;
module.exports.isDowngrade = isDowngrade;
module.exports.getTierOrder = getTierOrder;
module.exports.getPlanByTier = getPlanByTier;
module.exports.validateSubscriptionLimits = validateSubscriptionLimits;
