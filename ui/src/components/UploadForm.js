  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">
        {isCollab ? 'Upload Collaboration' : 'Upload a Track'}
      </h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Only show file upload if not a collab upload */}
        {!isCollab && (
          <div>
        ...
        {/* Show recording info if this is a collab upload */}
        {isCollab && recordingAudioBuffer && (
          <div className="p-3 bg-green-50 border border-green-200 rounded">
            <p className="text-sm text-gray-700">
              <strong>Recording ready for upload</strong>
            </p>
          </div>
        )}
